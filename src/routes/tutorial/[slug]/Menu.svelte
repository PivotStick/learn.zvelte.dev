<script>
	 ...
	 * @param {() => void } callback
	 */
	function focus_outside(node, callback) {
		/** @param {FocusEvent} e */
...
>
	<header>
		...
		>
			<i class="fa fa-arrow-left" style="font-size: 1rem"></i>
		</a>

		<div class="heading" on:click={() => (is_open = !is_open)} class:open={is_open}>
			<h1>
				<div class="mobile">
											...
											{#each part.chapters as chapter (chapter.slug)}
												...
												>
													...
													>
														...
														<i class="fa fa-chevron-right" style="font-size: 1rem" />
														{chapter.title}
													</button>
